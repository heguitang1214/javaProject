...
//        PriorityQueue<java.lang.Process> priorityQueue=new PriorityQueue<>(false);

//        System.out.println("初始化队列");
//        priorityQueue.add(new java.lang.Process("进程1",10));
//        priorityQueue.add(new java.lang.Process("进程2",1));
//        priorityQueue.add(new java.lang.Process("进程3",8));
//        priorityQueue.add(new java.lang.Process("进程4",3));
//        priorityQueue.add(new java.lang.Process("进程5"));
