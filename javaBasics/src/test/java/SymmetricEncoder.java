...
public class SymmetricEncoder {
    ...
    public static void main(String[] args) {
        String encodeRules = "舍非园艺212121312";
        String content = "11";
...
//        System.out.println("解密后的明文为：" + AESDncode(encodeRules, AESEncode(encodeRules, content)));
        ...
        System.out.println("解密后的明文为：" + AESDncode(encodeRules, "RLPA96uib432u9Dt5zRkVw=="));
        System.out.println("解密后的明文为：" + AESDncode(encodeRules, "sx8Ph+HIp6ac2oAvuhkBvw=="));
